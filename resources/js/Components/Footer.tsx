  ...
  return (
    <>
        ...
        <div className="container">
          <div className="grid grid-cols-4 gap-10">
            <div className="col-span-1">
              ...
              <p className="mt-8 mb-10 text-sm">
            ...
            <div className="col-span-1">
              <h5 className="font-sen font-bold text-xl">Tautan Cepat</h5>
              ...
              <div className="mt-4 flex flex-col space-y-3.5 text-sm">
                <a href="#">Beranda</a>
                <a href="#">Profil</a>
                <a href="#">Berita</a>
                <a href="#">Galeri</a>
            ...
            <div className="col-span-1">
              <h5 className="font-sen font-bold text-xl">Eksternal Link</h5>
              <div className="w-full h-1 relative mt-2">
                <div
                  className="absolute left-0 top-0 h-[1px] bg-[#2A619D]"
                  style={{ width: "10%" }}
            ...
            <div className="col-span-1">
              <h5 className="font-sen font-bold text-xl">Kontak</h5>
              <div className="w-full h-1 relative mt-2">
                <div
                  className="absolute left-0 top-0 h-[1px] bg-[#2A619D]"
                  style={{ width: "10%" }}
      ...
      <section className="bg-[#1A3C61]">
        <div className="container py-7 text-sm text-white text-center">
          Copyright &copy; 2025{" "}
